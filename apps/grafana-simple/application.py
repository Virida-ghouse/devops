#!/usr/bin/env python3
"""
VIRIDA Grafana - Application principale
"""
...
def start_grafana():
    ...
    try:
        ...
        env['GF_SERVER_ROOT_URL'] = f'https://virida-grafana-simple.cleverapps.io'
...
def home():
    ...
    return jsonify({
        ...
        'grafana_external': 'https://virida-grafana-simple.cleverapps.io',
...
def grafana_status():
    if check_grafana_health():
        return jsonify({
            ...
            'external_url': 'https://virida-grafana-simple.cleverapps.io'
        })
    else:
        return jsonify({
            'status': 'starting',
